...
def generate_password_gui():
    ...
    length_label = tk.Label(root, text="Password Length:",fg="black")
    ...
    simple_radio = tk.Radiobutton(root, text="Simple",bg="light green",variable=complexity_var,value=1)
    simple_radio.pack(anchor=tk.W)
    medium_radio = tk.Radiobutton(root, text="Medium",bg="light green",variable=complexity_var, value=2)
    medium_radio.pack(anchor=tk.W)
    complex_radio = tk.Radiobutton(root, text="Complex",bg="light green",variable=complexity_var, value=3)
    complex_radio.pack(anchor=tk.W)
    
    # Generate button
    generate_button = tk.Button(root, text="Generate Password", command=generate,fg="red")
    generate_button.pack(pady=20)
    
    password_var = tk.StringVar()
    password_label = tk.Label(root, text="Generated Password:",fg="red")
    password_label.pack()
    password_entry = tk.Entry(root, textvariable=password_var, state='readonly',fg="red")
    password_entry.pack()
